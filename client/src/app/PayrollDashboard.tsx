              ...
              <div key={staff.id || staff._id} className="p-6 hover:bg-white/5 transition-all group flex items-center justify-between">
                ...
                <div className="flex items-center gap-10">
                  ...
                  {!payroll ? (
                    ...
                    <span className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest border ${payroll.status === 'PAID' ? 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20' : 'bg-amber-500/10 text-amber-500 border-amber-500/20'
                      }`}>
                      {payroll.status}
                    </span>
                  )}
